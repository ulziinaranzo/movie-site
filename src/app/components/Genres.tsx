            ...
            genres.map((genre) => (
              <Badge
                ...
                className="cursor-pointer bg-white dark:bg-[#171717] border-gray-200 dark:border-[#262626]
                          hover:bg-gray-100 dark:hover:bg-[#262626] transition-colors"
                onClick={() => handleGenreClick(genre.id)}
              >
                {genre.name}
                
                <span className="ml-2 dark:hidden block"><GenreIcon/></span>
                <span className="ml-2 dark:block hidden"><GenreBlackIcon/></span>
              </Badge>
            ))
          ) : (
